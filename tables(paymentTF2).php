        ...
        <div class="templatemo-content">
         ...
         <h1>Payments</h1>
          ...
          <div class="row margin-bottom-30">
			...
			$result6_a=mysqli_query($conn,"select * from payment,parent where payment.parent_id_fk = parent.parent_id  and payment_status='No' limit $page1,6;");
			?>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="table-responsive">
                 <h4 class="margin-bottom-15">Tuition Fees <span style="color:red;">(Reject)</span></h4>
              ...
              <?php if($page >= 2){ ?>
                <li><a href="tables(paymentTF2).php?page=<?php echo $previouspage;?>">&laquo;</a></li>
			  <?php } ?>
				<?php for($b=1;$b<=$a;$b++){?>
                <li><a href="tables(paymentTF2).php?page=<?php echo $b?>"><?php echo $b?><span class="sr-only">(current)</span></a></li>
				<?php
				}
				?>
				<?php if($page != $endpage){ ?>
                <li><a href="tables(paymentTF2).php?page=<?php echo $nextpage;?>">&raquo;</a></li>
				 <?php } ?>
			</ul>  
            </div>
          </div>
