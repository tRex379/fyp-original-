      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <div class="row margin-bottom-30">
           ...
           ?>
           <script type="text/javascript">
           window.location.replace("ad_tables(parent).php?page=<?php echo $page?>"); 
           </script>
           <?php
            }
           ?>
          ...
          <div class="row">
                  ...
                  <tbody>
                    <tr>
					  ...
					  <td><?php if($row["barred_status"]=="unbarred"){
						  ?>
						  <a href="ad_tables(parent).php?prid=<?php echo $row['parent_id']."&page=".$page;?>" onclick="return confirmation()" class="btn btn-warning">Barred</a>
						  <?php
					      }
						  else if(($row["barred_status"]=="barred"))
						  {
						  ?>
						 <a href="ad_tables(parent).php?prid1=<?php echo $row['parent_id']."&page=".$page;?>" onclick="return confirmation1()" class="btn btn-success">Unbarred</a>
						  <?php
						  }
						  ?>
					  </td>			
			...
			?>
              ...
              <?php if($page >= 2){ ?>
                <li><a href="ad_tables(parent).php?page=<?php echo $previouspage;?>">&laquo;</a></li>
			  <?php } ?>
				<?php for($b=1;$b<=$a;$b++){?>
                <li><a href="ad_tables(parent).php?page=<?php echo $b?>"><?php echo $b?><span class="sr-only">(current)</span></a></li>
				<?php
				}
				?>
				<?php if($page != $endpage){ ?>
                <li><a href="ad_tables(parent).php?page=<?php echo $nextpage;?>">&raquo;</a></li>
				 <?php } ?>
			</ul>  
            </div>
          </div>
