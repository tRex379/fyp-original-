...
<?php 
	 ...
	 { 
	   ...
	   $adpassword=base64_encode($_POST["Ad_Password"]);
	     ...
	     $result=mysqli_query($conn,"update admin set Contact_Number='$adcontact',Email='$ademail',Password='$adpassword' where id=$sess_stfid");
