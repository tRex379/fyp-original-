      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <div class="row margin-bottom-30">
			 ...
			 $result8=mysqli_query($conn,"select * from parent where barred_status='blocked'");
			...
			$result8_a=mysqli_query($conn,"select * from parent where barred_status='blocked' limit $page1,6;");
			
			if(isset($_POST["btnSearch"]))
           {
	        $kw=$_POST["search_box"];
	        $result8_a=mysqli_query($conn,"select * from parent where barred_status='blocked' and parent_name like '%$kw%' or barred_status='blocked' and parent_ic like '%$kw%' or barred_status='unbarred' and parent_email like '%$kw%'");
           }
           ?>
          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="btn-group pull-right" id="templatemo_sort_btn">
			  ...
			  <h4 class="margin-bottom-15">List of Parents <span style="color:red">(Blocked)</span></h5>
			  <ul>
			 ...
			 ?>
                  <tbody>
                    <tr>
					  ...
					  <td>
					  <a href="ad_tables(parent)3.php?prid=<?php echo $row['parent_id']."&page=".$page;?>" onclick="return confirmation()" class="btn btn-warning">Barred</a>  
					  <a href="ad_tables(parent)3.php?prid1=<?php echo $row['parent_id']."&page=".$page;?>" onclick="return confirmation1()" class="btn btn-success">Unbarred</a>
					  </td>		
			...
			?>
              ...
              <?php if($page >= 2){ ?>
                <li><a href="ad_tables(parent)3.php?page=<?php echo $previouspage;?>">&laquo;</a></li>
			  <?php } ?>
				<?php for($b=1;$b<=$a;$b++){?>
                <li><a href="ad_tables(parent)3.php?page=<?php echo $b?>"><?php echo $b?><span class="sr-only">(current)</span></a></li>
				<?php
				}
				?>
				<?php if($page != $endpage){ ?>
                <li><a href="ad_tables(parent)3.php?page=<?php echo $nextpage;?>">&raquo;</a></li>
				 <?php } ?>
			</ul>  
            </div>
          </div>
...
?>
<script type="text/javascript">
window.location.replace("ad_tables(parent)3.php?page=<?php echo $page?>"); 
</script>
<?php
}
?>
