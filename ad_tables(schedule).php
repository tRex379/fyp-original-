          ...
          <div class="row">
            <div class="col-md-12">
              <div class="table-responsive">
				...
				<button type="button" class="btn btn-info" onclick="location.href = 'ad_tables(schedule)1.php'">Timetable View</button>
			  ...
			  ?>
                  <tbody>
                    <tr>
                      ...
                      <td><a href="ad_edit(schedule).php?schid=<?php echo $row['schedule_id']."&page=".$page;?>" class="btn btn-info">Update</a></td>                    
                      <td><a href="ad_tables(schedule).php?schid=<?php echo $row['schedule_id']."&page=".$page;?>" onclick="return confirmation()" class="btn btn-danger">Delete</a></td>			
                    </tr>    					
                  </tbody>
			  <?php
			   }
              ...
              <?php if($page >= 2){ ?>
                <li><a href="ad_tables(schedule).php?page=<?php echo $previouspage;?>">&laquo;</a></li>
			  <?php } ?>
				<?php for($b=1;$b<=$a;$b++){?>
                <li><a href="ad_tables(schedule).php?page=<?php echo $b?>"><?php echo $b?><span class="sr-only">(current)</span></a></li>
				<?php
				}
				?>
				<?php if($page != $endpage){ ?>
                <li><a href="ad_tables(schedule).php?page=<?php echo $nextpage;?>">&raquo;</a></li>
				 <?php } ?>
			</ul>  
            </div>
          </div>
...
?>
<script type="text/javascript">
window.location.replace("ad_tables(schedule).php?page=<?php echo $page?>"); 
</script>
<?php
}
?>
