            ...
            <div class="col-md-12">
               <form role="form" method="post" action="" id="teacherform" name="teacherform">
                ...
                <div class="row">
				 <div class="col-md-6 margin-bottom-15">
                  ...
                  <select class="form-control margin-bottom-15" name="Gender" id="Gender">
				    <option value="<?php echo $row["Gender"];?>">Current : <?php echo $row["Gender"];?></option>
			    ...
			    <div class="row">
				  ...
				  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="password" class="form-control" name="T_Password"  id="T_Password" value="<?php echo base64_decode($row["Password"]);?>">
				...
				<div class="row">
				  <div class="col-md-6 margin-bottom-15">
                    ...
                    <input type="password" class="form-control" name="T_C_Password" id="T_C_Password">
                    <span style="color:red" name="c_password_error" id="c_password_error">&nbsp;</span>					
                  </div>
                </div>
				<div class="panel panel-info">
                  <div class="panel-heading">Assign Teach Subjects</div>
                </div>
                 <div class="row">
				<div class="col-md-6 margin-bottom-15">
               ...
               <div class="row templatemo-form-buttons">
                <div class="col-md-12" style="margin-bottom:3%;margin-top:2%">
                  ...
                  <button type="button" class="btn btn-default" onclick="location.href = 'tch_index.php'">Cancel</button> 
                </div>
              </div>
            </form>
          </div>
...
<?php 
	 ...
	 { 
	   ...
	   $tpassword=base64_encode($_POST["T_Password"]);
	   $ttsub1=$_POST["T_Sub1"];
	   $ttsub2=$_POST["T_Sub2"];
	   $ttsub3=$_POST["T_Sub3"];
	   
	     $result1=mysqli_query($conn,"update teacher set Name='$tname',IC_No='$tic',Gender='$tgender',
		 Contact_Number='$tcontact',Email='$temail',Password='$tpassword',Teach_Subject1='$ttsub1',Teach_Subject2='$ttsub2',Teach_Subject3='$ttsub3' where Id=$sess_tchid");
