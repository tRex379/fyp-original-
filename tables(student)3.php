      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <div class="row margin-bottom-30">
			 ...
			 $result7=mysqli_query($conn,"select * from student,parent where student.parent_id_fk = parent.parent_id and parent.barred_status='blocked';");
			...
			$result7_a=mysqli_query($conn,"select * from student,parent where student.parent_id_fk = parent.parent_id and parent.barred_status='blocked' limit $page1,6;");
			
			if(isset($_POST["btnSearch"]))
           {
	        $kw=$_POST["search_box"];
	        $result7_a=mysqli_query($conn,"select * from student,parent where student.parent_id_fk = parent.parent_id and parent.barred_status='blocked' and student.student_name like '%$kw%' 
			or student.parent_id_fk = parent.parent_id and parent.barred_status='blocked' and student.student_ic like '%$kw%' 
			or student.parent_id_fk = parent.parent_id and parent.barred_status='blocked' and student_subject like '%$kw%'");
           }
			?>
          ...
          <div class="row">
            <div class="col-md-12">
			 <div class="btn-group pull-right" id="templatemo_sort_btn">
                ...
                <h4 class="margin-bottom-15">List of Students <span style="color:orange">(Blocked)</span></h4>
			  <ul>
			...
			?>
              ...
              <?php if($page >= 2){ ?>
                <li><a href="tables(student)3.php?page=<?php echo $previouspage;?>">&laquo;</a></li>
			  <?php } ?>
				<?php for($b=1;$b<=$a;$b++){?>
                <li><a href="tables(student)3.php?page=<?php echo $b?>"><?php echo $b?><span class="sr-only">(current)</span></a></li>
				<?php
				}
				?>
				<?php if($page != $endpage){ ?>
                <li><a href="tables(student)3.php?page=<?php echo $nextpage;?>">&raquo;</a></li>
				 <?php } ?>
			</ul>  
            </div>
          </div>
