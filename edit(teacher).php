      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
            ...
            <li><a href="tables(teacher).php?page=1">List of Teacher</a></li>
            ...
            <div class="col-md-12">
               ...
               <div class="row templatemo-form-buttons">
                <div class="col-md-12" style="margin-bottom:3%;margin-top:2%">
                  ...
                  <button type="button" class="btn btn-default" onclick="location.href = 'tables(teacher).php?page=<?php echo $page?>'">Cancel</button> 
                </div>
              </div>
            </form>
          </div>
...
<script type="text/javascript">
       swal({
		 ...
		 setTimeout(function(){ window.location = "tables(teacher).php?page=1"; }, 5000)
