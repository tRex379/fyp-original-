    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <h1 style="margin-bottom:20px;">ADD SCHEDULE</h1>
		  <div class="table-responsive">
		   <div class="btn-group pull-right" style="margin-top:50px" id="templatemo_sort_btn">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="ad_addschedule.php">Full View</a></li>
				  <li><a href="ad_addschedule(PT3).php">- PT3</a></li>
                  <li><a href="ad_addschedule(SPM).php">- SPM</a></li>
                </ul>
              </div>
			  <p class="margin-bottom-15" style="color:#0000ff">Instructions:<br />- Click on the table cell to add new schedule</p>
			  <div>
			  <button class="btn btn-primary" style="margin-bottom:15px;" onclick="location.href = 'ad_addschedule1.php'">Form View</button>
			  <button class="btn btn-info" style="margin-bottom:15px;margin-left:5px;" name="print" id="print" >Print Schedule</button>
			  </div>
                <?php include('schedule(SPM).php');?>
           </div>
                </div>
              </div>
	...
	<div class="modal fade" id="classModal" tabindex="-1" role="dialog" aria-labelledby="classModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
		 ...
		 <div class="col-md-8 margin-bottom-15">
		 <label for="Time" class="control-label">Capacity<span style="color:blue"> (Min:1 Max:30)</span></label>
...
?>
		 ...
		 window.location.replace("ad_addschedule.php");
	     </script>
<?php
	  }
	 }
