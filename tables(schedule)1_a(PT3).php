      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
			...
			<li class="active">Table of Schedule</li>
          </ol>
         <h1>Management</h1>
		  ...
		  <div class="col-md-12">
			...
			<div class="btn-group pull-right" id="templatemo_sort_btn">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="tables(schedule)1_a.php">Full View</a></li>
                  <li><a href="tables(schedule)1_a(SPM).php">- SPM</a></li>
				  <li><a href="tables(schedule)1_a(PT3).php">- PT3</a></li>
                </ul>
              </div>
		   <button type="button" style="margin-bottom:15px;" class="btn btn-info" onclick="location.href = 'tables(schedule).php?page=1'">Record View</button>
		   <h1 style="margin-bottom:20px;">SCHEDULE(<span style="color:blue">PT3</span>)</h1>
		   <?php include('schedule1_a(PT3).php');?>
		   <ul class="pagination pull-right">
		        <li><a href="tables(schedule)1.php">&laquo;</a></li>
                <li><a href="tables(schedule)1.php">1<span class="sr-only"></span></a></li>
				<li class="active"><a href="tables(schedule)1_a.php">2<span class="sr-only">(current)</span></a></li>
			</ul> 
          </div>			
          </div>
        </div>
...
?>
<script type="text/javascript">
window.location.replace("tables(schedule)1.php"); 
</script>
<?php
}
?>
