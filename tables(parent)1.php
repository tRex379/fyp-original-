      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          ...
          <div class="row margin-bottom-30">
           ...
           ?>
           <script type="text/javascript">
           window.location.replace("tables(parent)1.php?page=<?php echo $page?>"); 
           </script>
           <?php
            }
           ?>
          ...
          <div class="row">
			 ...
			 ?>
                  <tbody>
                    <tr>
					  ...
					  <td><a href="tables(parent)1.php?prid=<?php echo $row['parent_id']."&page=".$page;?>" onclick="return confirmation()" class="btn btn-danger">Blocked</a></td>
			...
			?>
              ...
              <?php if($page >= 2){ ?>
                <li><a href="tables(parent)1.php?page=<?php echo $previouspage;?>">&laquo;</a></li>
			  <?php } ?>
				<?php for($b=1;$b<=$a;$b++){?>
                <li><a href="tables(parent)1.php?page=<?php echo $b?>"><?php echo $b?><span class="sr-only">(current)</span></a></li>
				<?php
				}
				?>
				<?php if($page != $endpage){ ?>
                <li><a href="tables(parent)1.php?page=<?php echo $nextpage;?>">&raquo;</a></li>
				 <?php } ?>
			</ul>  
            </div>
          </div>
