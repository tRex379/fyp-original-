		  ...
		  <div class="col-md-12">
			...
			<div class="btn-group pull-right" id="templatemo_sort_btn">
                ...
                <ul class="dropdown-menu" role="menu">
                  <li><a href="ad_tables(schedule)1_a.php">Full View</a></li>
                  <li><a href="ad_tables(schedule)1_a(SPM).php">- SPM</a></li>
				  <li><a href="ad_tables(schedule)1_a(PT3).php">- PT3</a></li>
                </ul>
              </div>
		   ...
		   <h1 style="margin-bottom:20px;">SCHEDULE (<span style="color:blue">SPM</span>)</h1>
		   <?php include('ad_schedule1_a(SPM).php');?>
		   <ul class="pagination pull-right">
		        <li><a href="ad_tables(schedule)1.php">&laquo;</a></li>
                <li><a href="ad_tables(schedule)1.php">1<span class="sr-only"></span></a></li>
				<li class="active"><a href="ad_tables(schedule)1_a.php">2<span class="sr-only">(current)</span></a></li>
			</ul> 
          </div>			
          </div>
        </div>
