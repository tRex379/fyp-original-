         ...
         <h1>Management</h1>
		  ...
		  <div class="btn-group pull-right" id="templatemo_sort_btn">
                ...
                <ul class="dropdown-menu" role="menu">
                 <li><a href="tables(schedule)1.php">Full View</a></li>
				  <li><a href="tables(schedule)1(PT3).php">- PT3</a></li>
                  <li><a href="tables(schedule)1(SPM).php">- SPM</a></li>
                </ul>
              </div>
		   ...
		   <?php include('schedule1(SPM).php');?>
		   <ul class="pagination pull-right">
                <li class="active"><a href="#">1<span class="sr-only">(current)</span></a></li>
				<li><a href="tables(schedule)1_a.php">2<span class="sr-only"></span></a></li>
                <li><a href="tables(schedule)1_a.php">&raquo;</a></li>
			</ul> 
          </div>			
          </div>
        </div>
