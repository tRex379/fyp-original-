<?php
 ...
 if($schid=="")
 {
	header("location:ad_tables(schedule)1_a.php");
 }
  ...
  <div id="main-wrapper">
    ...
    <div class="template-page-wrapper">
      ...
      <div class="templatemo-content-wrapper">
        <div class="templatemo-content">
          <ol class="breadcrumb">
		    ...
		    <li><a href="ad_tables(schedule).php?page=1">List of Schedule</a></li>
          ...
          <div class="row">
		   ...
		   <div class="row">
				  ...
				  <?php
			       $result1=mysqli_query($conn,"select * from subject where subject.Subject_Status='active';");
			       while($row1=mysqli_fetch_assoc($result1))
			       {
			      ?>
                    <option value="<?php echo $row1["Subject_Name"]?>(<?php echo $row1["Standard_Name"]?>)"><?php echo $row1["Subject_Name"]?>(<?php echo $row1["Standard_Name"]?>)</option>
				<?php
			       }
			      ?>
                  </select>
		  ...
		  <div class="col-md-8 margin-bottom-15">
				  ...
				  <?php
			       $result2=mysqli_query($conn,"select * from teacher where teacher.Status='active';");
			       while($row2=mysqli_fetch_assoc($result2))
			       {
			      ?>
                    <option value="<?php echo $row2["Name"]?>"><?php echo $row2["Name"]?>&nbsp;&nbsp;(<?php echo $row2["Teach_Subject1"]?>&nbsp;<?php echo $row2["Teach_Subject2"]?>&nbsp;<?php echo $row2["Teach_Subject3"]?>)</option>
				<?php
			       }
			      ?>
                  </select>
         ...
         <input type="text" class="form-control" name="capacity" id="capacity" value="<?php echo $row["capacity"];?>">
		 <span style="color:red" name="capacity_error" id="capacity_error">&nbsp;</span>
		 </div>
		 <div class="col-md-8 margin-bottom-15">
		 <label for="Time" class="control-label">Venue</label>
         <input type="text" class="form-control" name="displayVenue" id="displayVenue" value="<?php echo $row["venue"];?>">
      ...
      <div class="col-md-12" style="margin-bottom:3%">
            ...
            <button type="button" class="btn btn-default" onclick="location.href = 'ad_tables(schedule)1_a.php'">Cancel</button> 
          </div>
		  </div>
		</form>
          </div>
...
?>
		 ...
		 window.location.replace("ad_tables(schedule)1_a.php");
	     </script>
<?php
	  }
	 }
