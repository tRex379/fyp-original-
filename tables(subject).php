        ...
        <div class="templatemo-content">
			...
			if(isset($_POST["btnSearch"]))
           {
			...
			?>
              <ul class="nav nav-pills">
				...
				<li class="active"><a href="tables(subject).php?page=1">Subject<span class="badge"><?php echo $row3?></span></a></li>
          ...
          <div class="row">
			 ...
			 ?>
                  <tbody>
                    <tr>
                      ...
                      <td><a href="edit(subject).php?sbid=<?php echo $row['Subject_ID']."&page=".$page;?>" class="btn btn-info">Update</a></td>
                      <td>
					  <?php if($row["Subject_Status"]=="active"){
						  ?>
						  <a href="tables(subject).php?sbid=<?php echo $row['Subject_ID']."&page=".$page;?>" onclick="return confirmation()" class="btn btn-danger">Inactive</a>
						  <?php
					      }
						  else if(($row["Subject_Status"]=="inactive"))
						  {
						  ?>
						    <a href="tables(subject).php?sbid1=<?php echo $row['Subject_ID']."&page=".$page;?>" onclick="return confirmation1()" class="btn btn-success">Active</a>
					  <?php
						  }
						 ?>
                      </td>						 
			...
			?>
              ...
              <?php if($page >= 2){ ?>
                <li><a href="tables(subject).php?page=<?php echo $previouspage;?>">&laquo;</a></li>
			  <?php } ?>
				<?php for($b=1;$b<=$a;$b++){?>
                <li><a href="tables(subject).php?page=<?php echo $b?>"><?php echo $b?><span class="sr-only">(current)</span></a></li>
				<?php
				}
				?>
				<?php if($page != $endpage){ ?>
                <li><a href="tables(subject).php?page=<?php echo $nextpage;?>">&raquo;</a></li>
				 <?php } ?>
			</ul>  
            </div>
          </div>
...
?>
<script type="text/javascript">
window.location.replace("tables(subject).php?page=<?php echo $page?>"); 
</script>
<?php
}
?>
