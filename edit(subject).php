             ...
             <form role="form" method="post" action="" id="subject_form" name="subject_form">
              ...
              <div class="row templatemo-form-buttons">
                <div class="col-md-12">
                  ...
                  <button type="button" class="btn btn-default" onclick="location.href = 'tables(subject).php?page=<?php echo $page?>'">Cancel</button>
                </div>
              </div>
            </form>
          </div>
...
?>
		 ...
		 window.location = "tables(subject).php?page=1";
	     </script>
<?php	 
	   }
	 }
