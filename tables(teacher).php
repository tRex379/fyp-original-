         ...
         <h1>Management</h1>
			...
			?>
              <ul class="nav nav-pills">
			   <li><a href="tables(admin).php?page=1">Admin<span class="badge"><?php echo $row5?></span></a></li>
			    <li class="active"><a href="tables(teacher).php?page=1">Teacher<span class="badge"><?php echo $row1?></span></a></li>
          ...
          <div class="row">
            <div class="col-md-12">
			  ...
			  ?>
                  <tbody>
                    <tr>
                      ...
                      <td><a href="edit(teacher).php?tchid=<?php echo $row['Id']."&page=".$page;?>" class="btn btn-info">Update</a></td>
                      <td>
					  <?php if($row["Status"]=="active"){
						  ?>
						  <a href="tables(teacher).php?tchid=<?php echo $row['Id']."&page=".$page;?>" onclick="return confirmation()" class="btn btn-danger">Inactive</a>
						  <?php
					      }
						  else if(($row["Status"]=="inactive"))
						  {
						  ?>
						   <a href="tables(teacher).php?tchid1=<?php echo $row['Id']."&page=".$page;?>" onclick="return confirmation1()" class="btn btn-success">Active</a>
					  <?php
						  }
						 ?>
                      </td>						 
			  ...
			  <?php if($page >= 2){ ?>
                <li><a href="tables(teahcer).php?page=<?php echo $previouspage;?>">&laquo;</a></li>
			  <?php } ?>
				<?php for($b=1;$b<=$a;$b++){?>
                <li><a href="tables(teacher).php?page=<?php echo $b?>"><?php echo $b?><span class="sr-only">(current)</span></a></li>
				<?php
				}
				?>
				<?php if($page != $endpage){ ?>
                <li><a href="tables(teacher).php?page=<?php echo $nextpage;?>">&raquo;</a></li>
				 <?php } ?>
              </ul>  
            </div>
          </div>
...
?>
<script type="text/javascript">
window.location.replace("tables(teacher).php?page=<?php echo $page?>"); 
</script>
<?php
}
?>
