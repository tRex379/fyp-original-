<?php
 ...
 if($schid=="")
 {
	header("location:tables(schedule)1.php");
 }
    ...
    <div class="template-page-wrapper">
     <div class="navbar-collapse collapse templatemo-sidebar">
      ...
      <div class="col-md-12" style="margin-bottom:3%">
            ...
            <button type="button" class="btn btn-default" onclick="location.href = 'tables(schedule)1.php'">Cancel</button> 
          </div>
		  </div>
		</form>
          </div>
...
function capacity()
{
	...
	{
	  document.getElementById('capacity_error').innerHTML = "Please enter value from 1 to 3.";
	  return false;
	}
	else
	{
