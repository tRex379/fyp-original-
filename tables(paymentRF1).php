        ...
        <div class="templatemo-content">
         ...
         <h1>Payments</h1>
          ...
          <div class="row margin-bottom-30">
			...
			$result6_a=mysqli_query($conn,"select * from student,parent where parent.parent_id=student.parent_id_fk and student.register_status='Yes' limit $page1,6;");
			?>
          ...
          <div class="row">
            <div class="col-md-12">
              ...
              <div class="table-responsive">
                <h4 class="margin-bottom-15">Registartion Fees <span style="color:#ADFF2F;">(Accepted)</span></h4>
			  ...
			  ?>
                  <tbody>
                    <tr>
					  ...
					  <td><a href="#" class="pop"><img src="<?php echo $row["student_register_fee"];?>" style="width: 40px; height: 50px;">
                      Click to Enlarge
                      </a></td>			
                    </tr>    					
                  </tbody>
