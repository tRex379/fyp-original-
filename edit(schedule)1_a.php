<?php
 ...
 if($schid=="")
 {
	header("location:tables(schedule)1_a.php");
 }
    ...
    <div class="template-page-wrapper">
     <div class="navbar-collapse collapse templatemo-sidebar">
      ...
      <div class="col-md-12" style="margin-bottom:3%">
            ...
            <button type="button" class="btn btn-default" onclick="location.href = 'tables(schedule)1_a.php'">Cancel</button> 
          </div>
		  </div>
		</form>
          </div>
...
function capacity()
{
	...
	{
	  document.getElementById('capacity_error').innerHTML = "Please enter valuefrom 1 to 30.";
	  return false;
	}
	else
	{
...
?>
		 ...
		 window.location.replace("tables(schedule)1_a.php");
	     </script>
<?php
	  }
	 }
